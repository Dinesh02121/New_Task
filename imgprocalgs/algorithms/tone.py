...
"""
For This Class we use Wrapper funtional Implementation
"""

class SepiaAlgorithm(ImageAlgorithmBase):
   

    def __init__(self, src: str, dest: str, factor: int):
        self.src = src
        self.dest = dest
        self.factor = factor

    def process(self):
        make_sepia(self.src, self.dest, self.factor)
